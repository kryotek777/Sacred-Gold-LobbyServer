...
public record struct PacketSecurityData(SacredMsgType Type, int Length, uint SecurityKey, bool DynamicSize, bool FromClient, bool FromServer, bool FromUnknown)
{
    ...
    private static Dictionary<SacredMsgType, PacketSecurityData> PacketDictionary = new Dictionary<SacredMsgType, PacketSecurityData> {
        ...
        { SacredMsgType.UserJoinChannel, new(Type: SacredMsgType.UserJoinChannel, Length: 16, SecurityKey: 0xDDCCBB20, DynamicSize: false, FromClient: false, FromServer: false, FromUnknown: false)},
        { SacredMsgType.ChannelLeaveRequest, new(Type: SacredMsgType.ChannelLeaveRequest, Length: 14, SecurityKey: 0xDDCCBB21, DynamicSize: false, FromClient: true, FromServer: false, FromUnknown: false)},
        { SacredMsgType.OtherUserJoinedChannel, new(Type: SacredMsgType.OtherUserJoinedChannel, Length: 98, SecurityKey: 0xDDCCBB22, DynamicSize: false, FromClient: false, FromServer: false, FromUnknown: false)},
        { SacredMsgType.OtherUserLeftChannel, new(Type: SacredMsgType.OtherUserLeftChannel, Length: 98, SecurityKey: 0xDDCCBB23, DynamicSize: false, FromClient: false, FromServer: false, FromUnknown: false)},
